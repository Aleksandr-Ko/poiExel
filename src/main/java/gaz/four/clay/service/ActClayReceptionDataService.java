...
public class ActClayReceptionDataService {

    public ActClayReceptionDTO getActClayReceptionDTO () {
        // заглушка с датой
        Date now = new Date();
        ...
        ActClayReceptionDTO dto = new ActClayReceptionDTO();
        ...
        dto.setViewClay("Глинистые грунты");
