...
public class ActCragReceptionDataService {

    public ActCragReceptionDTO getActCragReceptionDTO (){
        ...
        ActCragReceptionDTO  dto = new ActCragReceptionDTO();
        ...
        dto.setViewCrag("Скальные породы");
        dto.setCapacityCrag("113");
        dto.setCragGOST("80568-2014");
